...
<html>
    ...
    <center>
        <div class="container home">
            ...
            <h3><center> List of Files Uploaded By Your Teacher </center> </h3>
            </font>
            ...
            <table class="table table-bordered">
		     ...
		     href='download.php?id={$row['file']}'>{$row['file']} </a>";
                    ...
                    echo '<br/>';
                    if ($page_cur > 1) {
                        echo '<a href="view_teacher_file.php?page=' . ($page_cur - 1) . '" style="cursor:pointer;color:DeepSkyBlue ;" ><input style="cursor:pointer;background-color:DeepSkyBlue;border:1px black solid;border-radius:5px;width:120px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Previous "></a> ';
                    } else {
                    ...
                    for ($i = 1; $i < $total_page; $i++) {
                        if ($page_cur == $i) {
                            ...
                            echo '<a href="view_teacher_file.php?page=' . $i . '"> <input style="cursor:pointer;background-color:DeepSkyBlue ;border:1px black solid;border-radius:5px;width:30px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value="' . $i . '"> </a> ';
                        }
                    }
                    if ($page_cur < $total_page) {

                        echo '<a href="view_teacher_file.php?page=' . ($page_cur + 1) . '"><input style="cursor:pointer;background-color:DeepSkyBlue ;border:1px black solid;border-radius:5px;width:90px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Next "></a>';
                    } else {
