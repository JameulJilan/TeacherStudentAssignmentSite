...
<html>
    ...
    <br><center>
        <div class="container home">
            ...
            <h3><center> List of Files Uploaded By <?php echo $_SESSION['student_name']; ?> </center> </h3>
            </font>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    $query1 = "select count(*) \"total\" from file_student where id='$student_id'";
                    ...
                    $query3 = "select * from file_student order by s_f_id DESC limit $k,$dis";
		     ...
		     href='download.php?id={$row['file']}'>{$row['file']} </a>";
                    ...
                    echo '<br/>';
                    if ($page_cur > 1) {
                        echo '<a href="display_student.php?page=' . ($page_cur - 1) . '" style="cursor:pointer;color:DeepSkyBlue ;" ><input style="cursor:pointer;background-color:DeepSkyBlue;border:1px black solid;border-radius:5px;width:120px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Previous "></a> ';
                    } else {
                    ...
                    for ($i = 1; $i < $total_page; $i++) {
                        if ($page_cur == $i) {
                            ...
                            echo '<a href="display_student.php?page=' . $i . '"> <input style="cursor:pointer;background-color:DeepSkyBlue ;border:1px black solid;border-radius:5px;width:30px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value="' . $i . '"> </a> ';
                        }
                    }
                    if ($page_cur < $total_page) {

                        echo '<a href="display_student.php?page=' . ($page_cur + 1) . '"><input style="cursor:pointer;background-color:DeepSkyBlue ;border:1px black solid;border-radius:5px;width:90px;height:30px;color:white;font-size:15px;font-weight:bold;" type="button" value=" Next "></a>';
                    } else {
